      ...
      >
        ...
        <el-table-column fixed="right" label="操作" width="200" align="center">
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" title="开始调查" @click="startSurvey(scope.row)">
      ...
      >
        <div class="divbox">
          <div class="header">
            ...
            <div class="two-s">
              <!-- 暂时去掉 -->
              <span style="font-size: 12px;">审批&nbsp;&nbsp;</span>
...
export default {
  ...
  methods: {
    ...
    issue() {
      //this.form.status='3';
      // console.log(this.checkedPeople.join());
      // this.form.userIdList=this.checkedPeople.join();
      // console.log(this.form.userIdList);
      // axios({
      //     method:'post',
      //     url:'/api/current-events/savaAndRelease',
      //     data:this.form,
      //     headers:{
      //         'Content-Type': 'application/json;charset=UTF-8',
      //         'token':'8bd78e56d04efb380429cd8045ae6121'
      //     }
      // }).then((res)=>{
      //     console.log(res);
