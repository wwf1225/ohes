        ...
        <div class="info">
          ...
          <div class="input-div">
            ...
            <div class="location" style="padding-left:10%">
              <label class="label-div">事件地点</label>
...
export default {
  ...
  methods: {
          ...
          if (result.data.status == 200) {
            ...
            result.data.body.forEach(v => {
              v.children.forEach(v1 => {
                if (v1.value == this.form.diseaseId) {
                  this.defaultValue.push(v.value);
                  this.defaultValue.push(v1.value);
                }
              });
            });
          }
    ...
    eventPlaceInfo(value) {
      var item = this.schoolList.find(v => v.id == value);
      this.form.address = item.address;
      this.form.latitude = item.latitude;
      this.form.longitude = item.longitude;
      this.addpoint(+item.longitude, +item.latitude);
    },
    claerInput() {
  ...
  mounted() {
    ...
    this.eventGenreChang(this.form.genre);
