  ...
  <div class="rolebox">
    ...
    <div class="rolemgr-container">
      ...
      >
        ...
        <!-- <el-table-column prop="address" label="事发地点" align="center"></el-table-column> -->
        <el-table-column label="事件地点" align="center">
          <template slot-scope="scope">
            <span>{{scope.row.address}}&nbsp;{{scope.row.detailName?scope.row.detailName:''}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="reportPhone" label="报告人电话" align="center" width="150"></el-table-column>
        <el-table-column prop="reportUser" label="报告人姓名" align="center" width="120"></el-table-column>
