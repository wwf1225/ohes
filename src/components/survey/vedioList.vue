        ...
        <div class="vedio_main">
            <div class="v_top">
                <el-breadcrumb separator-class="el-icon-arrow-right" >
                    ...
                    <el-breadcrumb-item >影像列表</el-breadcrumb-item>
                </el-breadcrumb>
                <button class="top_btn" @click="close">返回</button>
            </div>
            <!-- 添加按钮 -->
            <div class="btn-add">
                <el-button type="primary" size="small" @click="addVedio">上传音像资料</el-button>
            </div>
            <!-- 搜索框 -->
            <div class="from_box">
                <div class="from_title">影像列表</div>
                <div>
                    <el-input v-model="fromQuery.mediaName" placeholder="请输入内容"></el-input>
                </div>
                <div class="from_btn">
                    <el-button type="primary" size="small" icon="el-icon-search" @click="getVedioList">搜索</el-button>
                </div>
            </div>
            <!-- 表格 -->
            <el-table ref="multipleTable" align="left" :data="tableData" element-loading-text="拼命加载中" bordertooltip-effect="dark" style="width: 100%">
                ...
                <el-table-column fixed="right" label="操作" width="180"  align="center">
                    <template slot-scope="scope">
                        <el-button v-if="scope.row.type==1" type="text" size="small" @click="showImg(scope.row)" >预览图片</el-button>
                        ...
                        <el-button  type="text" size="small" @click.native.prevent="delVedio(scope.row)" >删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <!-- 分页 class="block"-->
